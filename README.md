...
https://doi.org/10.1016/j.cag.2025.104452
Big Five and Myers–Briggs Type Indicator (MBTI) auf unterschiedlicher Granularität und in Time
Prompt based classification

- Do LLMs Have Distinct and Consistent Personality? TRAIT: Personality Testset designed for LLMs with Psychometrics
https://doi.org/10.48550/arXiv.2406.14703
Big Five and  Short Dark Triad (SD-3)
Finings: "1) LLMs exhibit distinct and consistent personality, which is highly influenced by their training data (e.g., data used for alignment tuning), and 2) current prompting techniques have limited effectiveness in eliciting certain traits, such as high psychopathy or low conscientiousness, suggesting the need for further research in this direction"
Questionare based
classifieres with gpt4 per prompt 



- Overview of psychometrics for LLMs
  https://github.com/ValueByte-AI/Awesome-LLM-Psychometrics
  
- Decoding LLM Personality Measurement: Forced-Choice vs. Likert
  https://aclanthology.org/2025.findings-acl.480.pdf
  Limits of Questionairs and likert scales

  
- WHO IS CHATGPT? BENCHMARKING LLMS’ PSYCHOLOGICAL PORTRAYAL USING PSYCHOBENCH
https://arxiv.org/pdf/2310.01386
...
https://iclr.cc/virtual/2025/poster/31265
identifing relevant attention heads for Personality traits and modifying them 
uses Big Five and SDD-3
